...
use stm32f1xx_hal::{afio::MAPR, flash::ACR, i2c::{BlockingI2c, Mode}, pac::{I2C1, I2C2, USART2}, rcc::{Clocks, Config, CFGR}};
use crate::{pin_groups::{self, OscillatorControlPins}, pins::GpioCr, shared::{RX, TX}, BoardI2c1, BoardI2c2};
